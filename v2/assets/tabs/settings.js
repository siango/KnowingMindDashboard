export async function render(mount){
  mount.innerHTML=<div class='card' style='padding:20px'>
    ...
    <label class='muted'>API Endpoint (จะใช้กับแท็บ Overview)</label>
    <input id='api' class='search' style='width:100%' placeholder='https://your.api/endpoint'/>
    <p class='muted' style='margin-top:10px'>* จัดเก็บใน <code>localStorage</code> ของเบราว์เซอร์เท่านั้น</p>
  </div>;
